...
function generateMatahariBola(x, y, z, radius, segments) {
  ...
  var rainbowColors = [[255 / 255, 214 / 255, 79 / 255]];
...
function generateMatahariCone(x, y, z, radius, segments, rotationX, rotationY, rotationZ) {
  ...
  var rainbowColors = [[255 / 255, 180 / 255, 50 / 255]];
...
// generate ball untuk awan
function generateBall(x, y, z, radius, segments) {
  var vertices = [];
  var colors = [];
...
function main() {
  ...
  // inisialisasi awan
  // bola 1
  var awan1_1 = generateBall(0, 2.1, -1, 0.2, 50);
  ...
  // bola 2
  var awan1_2 = generateBall(-0.6, 1.6, -1, 0.2, 50);
  ...
  // bola 3
  var awan1_3 = generateBall(0.6, 1.6, -1, 0.2, 50);
  ...
  // bola 4
  var awan1_4 = generateBall(0, 1.8, -1, 0.3, 50);
  ...
  // bola 5
  var awan1_5 = generateBall(-0.2, 2, -1, 0.2, 50);
  ...
  // bola 6
  var awan1_6 = generateBall(0.2, 2, -1, 0.2, 50);
  ...
  // bola 7
  var awan1_7 = generateBall(-0.2, 1.5, -1, 0.2, 50);
  ...
  // bola 8
  var awan1_8 = generateBall(0.2, 1.5, -1, 0.2, 50);
  ...
  // bola 9
  var awan1_9 = generateBall(0, 1.5, -0.7, 0.2, 50);
  ...
  // bola 10
  var awan1_10 = generateBall(-0.4, 1.8, -0.8, 0.2, 50);
  ...
  //bola 11
  var awan1_11 = generateBall(0.4, 1.8, -0.8, 0.2, 50);
  ...
  // bola 12
  var awan1_12 = generateBall(-0.3, 1.5, -0.8, 0.2, 50);
  ...
  // bola 13
  var awan1_13 = generateBall(0.3, 1.5, -0.8, 0.2, 50);
  ...
  // bola 14
  var awan1_14 = generateBall(-0.4, 1.8, -1.2, 0.2, 50);
  ...
  // bola 15
  var awan1_15 = generateBall(0.4, 1.8, -1.2, 0.2, 50);
  ...
  // bola 16
  var awan1_16 = generateBall(-0.3, 1.5, -1.2, 0.2, 50);
  ...
  // bola 17
  var awan1_17 = generateBall(0.3, 1.5, -1.2, 0.2, 50);
  ...
  // bola 18
  var awan1_18 = generateBall(0, 1.5, -1.3, 0.2, 50);
